/* ProShopSetup.jsx
 *
 * Create-shop form rendered for PRO plan owners.
 * Currently mirrors BasicShopSetup — kept separate so Pro-specific
 * fields (e.g. multi-staff, advanced branding) can be added later
 * without touching the other plan pages.
 *
 * Props:
 *   isRevealed {boolean}
 */
    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4 max-w-lg">
                ...
                {/* TODO — Pro-only fields go here in a future iteration:
            e.g. team member invites, advanced branding options, custom domain */}
